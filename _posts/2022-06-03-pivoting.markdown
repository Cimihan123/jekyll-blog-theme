...
Our helper machine  ( gateway machine ) is sitting on both subnetworks.
...
<p align="center" style="color:white;">Fig:Brutefore with Hydra </p>
...
*ifconfig* shows that the *helper* machine is the part of two netwwork family.
...
The major concern is finding hosts.Having *nmap* would have been easier but mostly in real case scenerio you won't find it.
...
The reason why we cannot ping is because proxies do not support **icmp** prtocols.Their working OSI layers are different.
...
<p align="center" style="color:white;">Fig:Using Browswer </p>
...
Visit: *http://172.16.101.21/wp-admin/install.php*, we have to first finish the wordpress install process.

Set username and password for the administration.Complete the process. Now we are ready to exploit the *RCE* vulnerability.
...
![  wordpress installation  ><](/assets/img/blog4-pivoting/27-wordpress-install.png)
