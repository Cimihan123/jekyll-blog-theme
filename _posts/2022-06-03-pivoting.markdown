...
```
**4. Check on "New Host" then upload the tar file "pay.tar"**
...
For now, our target is HTTP service. Seems like it is running on WordPress cms.

![  curl victim2  ><](/assets/img/blog4-pivoting/26-victim2-wp-curl.png)
<p align="center" style="color:white;">Fig: Check</p>

If we have not automated the installation process with **wp-cli** then we first have to finish it manually.
